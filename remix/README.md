...
the Python engine behind Phantom's **Remix Lab** — stem separation, beat/tempo tracking, key detection, and time-stamped chords, using State-of-the-Art models (Demucs / BS-RoFormer, the BTC transformer, madmom, nnAudio).
